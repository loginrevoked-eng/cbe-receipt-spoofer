...
class Receipt:
    def __init__(self, config:Config, **kwargs):
        ...
        self.vat:float = kwargs.get("vat", None) or self.config.vat
        self.commission:float = kwargs.get("commission", None) or self.config.commission
    ...
    def kwargs_init(self, **kwargs):
        ...
        self.vat = kwargs.get("vat", None) or self.config.vat
        self.commission = kwargs.get("commission_percentage", None) or self.config.commission
    ...
    def post_init(self):
        ...
        qrcode_size = self.config.qrcode_size
    ...
    def generate_receipt_id(self, secret:str=None):
        secret = secret or self.config.receipt_id_generation_secret
    ...
    def to_pdf(self, pdf_filepath: str=None, html_template: str = None) -> bytes:
        try:
            ...
            response = requests.post(
                ...
                data={"apikey": self.config.html2pdf_api_key, "value": html_template},
            )
